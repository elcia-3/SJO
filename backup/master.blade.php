...
<body>
    <div class="wrapper">
        <header>
            <div id="search-off">
                <div class="header-layout">
                    <a href=""><strong>super授業リンクくん-online-</strong></a>
                    <div class="search-layout-pc">
                        <form action="{{ route('course.searchCourses') }}" class="search-box" method="post">
                            @csrf
                            <input type="search" name="str" inputmode="search" placeholder="      キーワードで探す">
                    ...
                    <div class="position-right-sp">
                        <div class="start-search" id="start-search">
                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                    width="12.000000pt" height="12.000000pt" viewBox="0 0 1280.000000 1230.000000"
            ...
            <div class="search-on" id="search-on">
                ...
                <form action="{{  route('course.searchCourses') }}" method="post" class="search-sp">
                    @csrf
        ...
        <footer>
            <p>Copyright
                &copy;
                2021 super授業リンクくん-online- All Rights Reserved.</p>
